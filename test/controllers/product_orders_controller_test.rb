...
class ProductOrdersControllerTest < ActionController::TestCase
  ...
  test "should create product_order" do
    assert_difference('ProductOrder.count') do
      post :create, product_order: { LineItem_id: @product_order.LineItem_id, Product_id: @product_order.Product_id, User_id: @product_order.User_id }
    end
  ...
  test "should update product_order" do
    patch :update, id: @product_order, product_order: { LineItem_id: @product_order.LineItem_id, Product_id: @product_order.Product_id, User_id: @product_order.User_id }
    assert_redirected_to product_order_path(assigns(:product_order))
  end
