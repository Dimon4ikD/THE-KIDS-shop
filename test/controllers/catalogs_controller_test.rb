...
class CatalogsControllerTest < ActionController::TestCase
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post :create, catalog: { HyTML: @catalog.HyTML, description: @catalog.description, name: @catalog.name }
    end
  ...
  test "should update catalog" do
    patch :update, id: @catalog, catalog: { HyTML: @catalog.HyTML, description: @catalog.description, name: @catalog.name }
    assert_redirected_to catalog_path(assigns(:catalog))
  end
